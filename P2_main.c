...
//TURN ALL LEDS THE CHOSEN COLOR
void ALL_LEDS(uint32_t color)
{
     uint8_t i=0;
     uint8_t j=0;
     uint32_t temp;
     //IDLE STATE OF PA7 WILL BE 1!!!
    //RESET SIGNAL 0 for >= 50us ^^^^^|__|INFO
    PORTA &= ~(1 << PORTA7);//START CONDITION
    //for >= 50 us _____________________________________________________________________________________________FROM HERE
    ...
    {  
      ...
      {      
            ...
            if(temp & 1)
          {
            ...
            //more than 50 us ___________________________________________________________________________________TO HERE  
...
//we will test without delays first
